...
export const MVPPathSection = () => (
    <div className="space-y-10">
        <h2 className="text-2xl font-semibold text-slate-900">{"The MVP Path: Off-the-Shelf Before Custom"}</h2>

        <Callout type="success" title="The Principle">
            {"Start with off-the-shelf solutions. Only build custom when you hit clear limitations. This section answers: \"What can I build WITHOUT writing a custom backend?\""}
        </Callout>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="flex-1 text-center">
                        <div className="bg-green-100 border border-green-300 rounded-lg p-4">
                            <h4 className="font-semibold text-green-800">Off-the-shelf MCP</h4>
                    ...
                    <div className="flex-1 text-center">
                        <div className="bg-blue-100 border border-blue-300 rounded-lg p-4">
                            <h4 className="font-semibold text-blue-800">Custom MCP tools</h4>
                    ...
                    <div className="flex-1 text-center">
                        <div className="bg-purple-100 border border-purple-300 rounded-lg p-4">
                            <h4 className="font-semibold text-purple-800">Router Pattern</h4>
        ...
        <ProgressiveSection number="2" title="Zapier MCP: Option 1 (Fastest)" subtitle="When managed solutions make sense">
            <Card className="p-4 bg-blue-50 border-blue-200 mb-4">
                <h4 className="font-semibold text-blue-800">What is Zapier MCP?</h4>
            ...
            <h4 className="font-semibold mb-3">Zapier MCP Strengths</h4>
            ...
            <h4 className="font-semibold mb-3">Zapier MCP Limitations</h4>
        ...
        <NextSectionNav currentId="mvppath" />
    </div>
);
