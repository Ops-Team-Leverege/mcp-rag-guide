    ...
    return (
        <div className="my-8 p-6 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* Router Pattern */}
                <div className="bg-white rounded-lg border-2 border-indigo-400 p-4 shadow-sm ring-2 ring-indigo-200">
                    <div className="bg-indigo-700 text-white text-center py-2 px-4 rounded-lg font-bold mb-4">
                        Router Pattern ★
                    </div>
                    <div className="space-y-3">
                        <div className="bg-green-200 border-2 border-green-400 rounded-lg p-3 text-center font-medium">
                        ...
                        <div className="bg-indigo-200 border-2 border-indigo-400 rounded-full p-3 text-center font-medium text-sm">
                            LLM (ONE call)
                        </div>
                        <div className="text-center text-xs text-gray-600 italic">↓ classifies intent</div>
                        <div className="bg-indigo-100 border-2 border-indigo-300 rounded-lg p-3 text-center">
                            <div className="font-medium text-sm text-indigo-800">Code Routes</div>
                            <div className="text-xs text-indigo-600 mt-1">Contract → Handler</div>
                        </div>
                        <div className="text-center text-xs text-gray-600 italic">↓ deterministic</div>
                        <div className="bg-blue-100 border-2 border-blue-300 rounded-lg p-2 text-center text-xs font-medium">
                            Handler + RAG
                        </div>
                        <div className="flex justify-center">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="text-xs text-center text-gray-600 mt-2 italic">
                            LLM classifies, code routes deterministically
                        </div>
                    </div>
                </div>
            ...
            <div className="mt-6 pt-4 border-t border-gray-300">
                <div className="text-sm text-gray-600 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-2 text-xs">
                        ...
                        <div className="md:col-span-2"><span className="font-semibold text-indigo-700">Router Pattern:</span> LLM classifies intent, code routes deterministically — audit trail, consistency</div>
                    </div>
                </div>
            </div>
        </div>
