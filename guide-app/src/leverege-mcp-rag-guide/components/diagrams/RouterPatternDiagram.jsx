...
const RouterPatternDiagram = () => {
  return (
    <div className="my-6 p-6 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl border border-slate-200">
      <h4 className="text-center font-semibold text-slate-800 mb-4">The Router Pattern: Decide First, Then Execute</h4>

      <div className="flex flex-col items-center gap-3">
        {/* User Question */}
        <div className="w-full max-w-md bg-green-100 border border-green-300 rounded-lg p-4 text-center animate-fade-in">
        ...
        <div className="w-full max-w-md bg-blue-100 border border-blue-300 rounded-lg p-4 animate-slide-in-left">
          <div className="font-semibold text-blue-800 mb-2">Step A: Intent Classification</div>
        ...
        <ChevronDown className="w-6 h-6 text-slate-400 animate-bounce" style={{ animationDelay: '0.2s' }} />

        {/* Step B: Scope Resolution */}
        <div className="w-full max-w-md bg-purple-100 border border-purple-300 rounded-lg p-4 animate-slide-in-right">
          <div className="font-semibold text-purple-800 mb-2">Step B: Scope Resolution</div>
        ...
        <ChevronDown className="w-6 h-6 text-slate-400 animate-bounce" style={{ animationDelay: '0.4s' }} />

        {/* Step C: Contract Selection */}
        <div className="w-full max-w-md bg-amber-100 border border-amber-300 rounded-lg p-4 animate-slide-in-left">
          <div className="font-semibold text-amber-800 mb-2">Step C: Contract Selection</div>
        ...
        <ChevronDown className="w-6 h-6 text-slate-400 animate-bounce" style={{ animationDelay: '0.6s' }} />

        {/* Processing Pipeline */}
        <div className="w-full max-w-md bg-green-100 border border-green-300 rounded-lg p-4 text-center animate-fade-in" style={{ animationDelay: '0.8s' }}>
