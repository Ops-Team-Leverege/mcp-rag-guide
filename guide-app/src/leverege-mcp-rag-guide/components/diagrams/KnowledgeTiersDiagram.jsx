...
const KnowledgeTiersDiagram = () => {
    ...
    return (
        <div className="my-6 p-6 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl border border-slate-200">
            <h4 className="text-center font-semibold text-slate-800 mb-2">Knowledge Tiers Pattern</h4>
            ...
            <div className="space-y-4">
                {tiers.map((tier, index) => {
                    ...
                    return (
                        <div key={index} className={`${colors.bg} border ${colors.border} rounded-xl p-5 shadow-sm transition-all hover:shadow-md`}>
                            <div className="flex items-start gap-4">
                                {/* Tier Number */}
                                <div className={`flex-shrink-0 w-12 h-12 rounded-full ${colors.iconBg} flex items-center justify-center`}>
                                    <span className={`text-xl font-semibold ${colors.iconText}`}>{tier.tier}</span>
                                </div>
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <h5 className={`text-lg font-semibold ${colors.text}`}>Tier {tier.tier}: {tier.name}</h5>
                                    </div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4 mb-3">
                                        ...
                                        <div>
                                            <div className="text-xs font-semibold text-slate-500 mb-1">TRUST LEVEL:</div>
                                            <div className={`text-sm font-semibold ${colors.text}`}>{tier.trustLevel}</div>
                                        </div>
                                    </div>

                                    <div className="mb-3">
                                        <div className="text-xs font-semibold text-slate-500 mb-1">BEHAVIOR:</div>
            ...
            <div className="mt-6 p-4 bg-white border border-slate-300 rounded-lg">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h5 className="font-semibold text-slate-900 mb-2">Why Tiers Matter</h5>
            ...
            <div className="mt-4 p-4 bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-300 rounded-lg">
                <h5 className="font-semibold text-purple-900 mb-3">Example: Answering "What's our refund policy?"</h5>

                <div className="space-y-3">
                    <div className="bg-white rounded-lg border border-green-300 p-3">
                        <div className="flex items-center gap-2 mb-1">
                            <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-600 font-semibold text-sm">1</div>
                    ...
                    <div className="bg-white rounded-lg border border-red-300 p-3">
                        <div className="flex items-center gap-2 mb-1">
                            <div className="w-6 h-6 rounded-full bg-red-100 flex items-center justify-center text-red-600 font-semibold text-sm">✗</div>
...
export default KnowledgeTiersDiagram;
