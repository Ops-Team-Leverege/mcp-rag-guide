...
const DebugFlowDiagram = () => {
    ...
    return (
        <div className="my-6 p-6 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl border border-slate-200">
            <h4 className="text-center font-semibold text-slate-800 mb-2">The 5-Minute Debug Protocol</h4>
            ...
            <div className="mt-6 p-4 bg-white border border-slate-300 rounded-lg">
                ...
                <div className="space-y-2">
                    {[
                        ...
                        <div key={i} className="flex items-start gap-3 text-sm bg-slate-50 rounded p-3 border border-slate-200">
                            <div className="flex-shrink-0 w-5 h-5 rounded-full bg-red-100 flex items-center justify-center text-red-600 font-semibold text-xs mt-0.5">
                                !
                            </div>
                            <div className="flex-1">
                                <div className="font-semibold text-slate-900">{pattern.symptom}</div>
            ...
            <div className="mt-4 p-4 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-300 rounded-lg">
                <h5 className="font-semibold text-blue-900 mb-2">The Structured Debug Log (Build This Early)</h5>
  ...
  "citations": 3
            ...
            <div className="mt-4 p-4 bg-purple-100 border border-purple-300 rounded-lg">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h5 className="font-semibold text-purple-900 mb-1">Key Insight</h5>
