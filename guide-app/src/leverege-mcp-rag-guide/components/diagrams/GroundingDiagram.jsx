...
const GroundingDiagram = () => {
    ...
    return (
        <div className="my-6 p-6 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200">
            <h4 className="text-center font-bold text-gray-800 mb-4">Grounding: The Solution to Hallucination</h4>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-lg border-2 border-red-300 p-5 shadow-sm">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h5 className="font-bold text-red-800">Without Grounding</h5>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="bg-red-200 border-2 border-red-400 rounded p-3">
                ...
                <div className="bg-white rounded-lg border-2 border-green-300 p-5 shadow-sm">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h5 className="font-bold text-green-800">With Grounding</h5>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="bg-green-200 border-2 border-green-400 rounded p-3">
                            <div className="flex items-start gap-2">
            ...
            <div className="mt-6 p-4 bg-amber-50 border-2 border-amber-300 rounded-lg">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <div className="font-bold text-amber-800 mb-1">The Cite or Abstain Rule</div>
